...
module.exports = function searchProducts() {
  return (req: Request, res: Response, next: NextFunction) => {
    ...
    models.sequelize.query(`SELECT * FROM Products WHERE ((name LIKE :criteriaReplacement OR description LIKE :criteriaReplacement) AND deletedAt IS NULL) ORDER BY name`,
      {
        replacements: {
          criteriaReplacement: '%' + criteria + '%'
        }
